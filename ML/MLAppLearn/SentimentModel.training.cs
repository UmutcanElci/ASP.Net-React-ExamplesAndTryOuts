...
namespace MLAppLearn
{
    public partial class SentimentModel
    {
        public const string RetrainFilePath =  @"C:\Users\Malat\Desktop\Code\net\ML\MLAppLearn\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=78,MinimumExampleCountPerLeaf=12,NumberOfTrees=37,MaximumBinCountPerFeature=780,FeatureFraction=0.768922454715383,LearningRate=0.00964767659755731,LabelColumnName=@"col1",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"col1"))      
